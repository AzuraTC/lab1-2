...
TS_ASSERT_EQUALS(Listalke6.start(1,1,100),"0")
    ...
    {
        listalke Listalke9,Listalke1,Listalke2,Listalke3,Listalke4,Listalke5,Listalke6,Listalke7,Listalke8; //создание объекта класса
...
TS_ASSERT_EQUALS(Listalke9.start(5,10,9),"1 << 5 6 7 8 [9] >> 10")
    }
};
